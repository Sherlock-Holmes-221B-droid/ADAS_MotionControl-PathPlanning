...
for frame_count in range(1000):
    ...
    steer_rate, K = Lqr.build_state_space(velocity=current_velocity,current_delta=vehicle_run.state.delta,curvature=metrics["curvature"])
